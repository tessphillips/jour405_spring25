...
There is a strong positive correlation shown in this scatterplot. As the temperatures get hotter in the summer months, the amount of murders is steadily increasing. In other words, rising temperatures means murders on the rise. The correlation calculation shows us that the data is about 50% related, which is not as strong as you would think based on the graph. 
