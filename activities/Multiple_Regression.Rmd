...
I believe that this could be considered a somewhat useful model. The multiple R-squared value of 0.6232 indicates high variability and would be considered useful and the 15.44 F-statistic paired with the low p-value shows us that the model is statistically significant. However, the RSE value is not ideal for our data, but it also could be a lot worse. SO, overall I would say this is a useful model. 
...
It appears that points scored is the most significant of the three factors, due to its high correlation to wins. Yards gained appears to be the least important factor, with a very low correlation to number of wins, and it it was not significant to the regression.
...
To make this story appealing to an audience who wouldn't understand this type of model, I would break down the numbers and their relationships, so that the average reader can more easily understand the significance of the factors and how they relate to the team's number of wins. For example, I would say that the factor of number of points scored is the most important thing to consider when looking at relationship to number of wins. I would then maybe cite some of the values involved in this correlation, but explain them in more simple terms of how they relate to each other and why its important. 
