...
When a respondent has a weight of 0.23, it means that they are over-represented. With a weight of 3.04, they are under-represented. 

3. Why might some respondents be weighted more heavily than others?

Some voters may be weighted more heavily if they are hard to get a hold of. People who don't vote aren't likely to answer surveys either. 
...
The category showing the biggest difference between weighted and unweighted results was the rarely/never voters voting "yes" with a difference of -3.6%.

2. How might these differences affect reporting on likely voter turnout?

It is hard to know whether people are being honest about voting, especially when doing man on the street interviews. It would require some really intense fact checking to confirm everything about surveys and random samples.
...
I think that the rarely/never category of voters is probably the most under-represented.
