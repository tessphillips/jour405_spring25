...
Generally speaking, the number of calls per day is pretty consistent, staying relatively within the same range. I think that the day would qualify as unusual if it was over 17 calls or under 5 calls. 
...
These answers differ from mine in task 3. My unusual low prediction was 5, where here it is 7. This is close, so I am not too surprised to see this. It makes sense that 7 is a more generalized unusual value. 11 seemed low to me as the unusually high number. I predicted 17 because 11 looked to be pretty common upon first glance. 
...
I would say that Saturday has the highest average number of overdose calls at 11.3, closely followed by Friday with an average of 11. 
...
I think the best angle for reporting would be to analyze the patterns involved. For example, why are warmer months more popular for drug overdose calls, do the police have any thoughts on the matter? Why do Fridays and Saturdays have the most drug overdose calls? (This one makes more sense because it is the weekend, but Mondays are also very high, why is this?) It would be critical to talk to the police and 911 operators. It would also be helpful to have the operators share some anecdotes, if possible, to add some more specific examples to this reporting. 
