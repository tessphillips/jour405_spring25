...
The data is slightly skewed to the right. The standard deviation to the right of the mean is significantly less common than that of the standard deviation to the left. The average (mean) is not fully accurate in this instance because the data is skewed to the right. If the data was more normal, the mean would be more accurate for the dataset.
