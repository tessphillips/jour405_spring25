...
team_aces <- matches |> 
  group_by(team) |> 
  summarize(total_aces = sum(aces)) |> arrange(desc(total_aces))
```
...
Although Maryland comes in the rankings at number 17, they are also in the 95th percentile. This means that UMD is the same as or better than 95 percent of the teams on the list. We mentioned this in class, but this aspect of the statistic is a better line for a story. It sheds a more positive light on UMD Volleyball stats rather than the rather negative ranking of being #17. 
