...
We can see from the data that this information is 99% not related, which tells us that there is basically no correlation. There is little to no pattern shown in this scatterplot. 
