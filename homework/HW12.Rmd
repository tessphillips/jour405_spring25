...
It is clear from the data that the pre-spike year was very indicative of an oncoming spike, even though the data for the pre-spike year was not as high as the spike year. Following the spike, we see numbers go down dramatically.
...
This chart gives a visualization that shows the increase that built up to the spike year. It then shows the decrease following the spike year. Before all of this, we can see that the numbers of car thefts remains pretty steady and relatively low. 

Title/lede: New data shows dramatic spike in car thefts between 2023 and 2024.  
...
- **Null Hypothesis (H0)**: For data shown, there is no difference between the pre-spike and post-spike data.

- **Alternative Hypothesis (H1)**: For the data shown, there is a significant difference between the pre-spike and post-spike data.
...
The ANOVA test shows us that there are significant differences between the time periods and their data. The p-value is less than 0.05, so it is significant data and we can reject the null hypothesis. 
...
The chart reiterates and visually proves that there is a lot of significance between the pre-spike and post-spike data. The visualization makes it so that there is no question about the difference between the two. 

Headline: Data shows vast differences in the number of car thefts before and after the 2023 spike. 

Shown in new data, we can see that the number of car thefts pre-spike was beginning to increase, according to our line chart. Prior to that, the data remained pretty low and steady. The spike occurred in 2023, showing record highs. But, following the spike, we are seeing a decreasing trend. The numbers are not as low as they were prior to the spike, but they are decreasing steadily since the spike.
