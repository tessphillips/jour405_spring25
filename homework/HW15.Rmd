...
The thing that stood out to me was the dip in number of daily accidents at the start of the 2020 year. This would make a lot of sense, as this is when the pandemic was in full swing and people were the most scared to leave their houses. I would like to look more into this and see what specific months/days were the lowest. Did accidents suddenly drop the day that the pandemic started?

Something else that I noticed was that it looks like the number of accidents is slightly lower in January and December, how does the weather/season correlate to the number of daily accidents? - this is something I would need to look further. 
...
The weekend, Friday and Saturday have the highest averages, this could possibly be linked to some accidents driving under the influence. The lowest averages are seen on Sundays and Mondays, Sundays are known to be restful, so it makes sense that accidents are low if people are not really leaving their homes. Monday is also the start of the week, so people are likely just following routine. 
...
I chose to look further into 2021-10-29. On this day, there were severe weather problems involving a flood. All schools in the county were closed on this day due to the extreme weather circumstances. I would incorporate this into a story as a way to explain why the number of accidents was so high this day. 
...
Generally, when I look at the differences between z-scores and day-of-week z-scores, there doesn't appear to be too much correlation between them. The only one that stood out to me was the day with the highest DOW Mean also had the highest DOW z-score, but other than that the rest of the z-scores are relatively similar. 
...
May and October have the highest average number of accidents, where January and March have the lowest. It can't be known the exact reason for this until further investigative reporting is done. 

However, my hypothesis is that a lot of people may be traveling towards the end of May, potentially for summer vactions, leading to a lot of traffic on state highways, and therefore leading to more accidents. October is a month full of Halloween celebrations, so this could lead to a lot of accidents due to drivers under the influence.

I am surprised to see that January is actually the month with the lowest average of accident. You would think that since roads are bad during the winter months, the number of accidents would be higher. 
...
For all of the outliers that are in the negatives, they have in common that they have numbers in the singular digits. For the positive outliers, they all have in common that they are above 45 but under 60. 
...
Pitch: I think that the most newsworthy story based on this data would be to look more in to the 2020 data. We could first talk about the drop in 2020, but then look at data to see how long it took to get back to the previously regular numbers. Were numbers still down for the years following the pandemic? We would examine that here. I would mostly need to talk to the police chief that was in charge at the time, asking him about patterns that he observed. 
Headline: Data shows decrease in average number of accidents during the pandemic. 
Lede: Newly released data shows the average numbers of car accidents across several years. The data shows us that the average number of accidents decreased drastically during and after the pandemic. 
