...
```
# Ten Maryland cities are above the 90th percentile. 
```{r}
...
I do not think I would change my story from the one I had previously pitched. My previous story was about how 9 of the cities saw an increase of over 100% in crime, and with this new data, it would only be changing the perspective to 10 cities rather than 9. I do not think this newfound data is compelling enough to completely change my story's direction. 
