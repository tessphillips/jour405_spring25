...
There is a very strong and positive correlation shown in this graph between GDP and DJIA. The plot illustrates the points on the graph very close together with just a few further out points. This tells us that there is a strong correlation. However, as DJIA gets larger, the correlation gets slightly less strong, as the points move slightly farther apart. 
