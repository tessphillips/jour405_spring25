...
The latter is different from expected, but generally speaking, it isn't that far off from what was expected to be seen. Most of the latter where more than expected, but the exceptions were the 5-star and 3-star ratings.
...
We should reject the null hypothesis. The chi square test gave us a value of 9.9521 and we received the critical value of 9.487729, because the chi square value is greater than the critical value, we should be rejecting the hypothesis. 
