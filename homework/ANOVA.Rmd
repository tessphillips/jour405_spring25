...
When comparing the SAT scores of students at different types of universities, there are some very clear differences. Students at private universities have a lot higher average scores than those at community colleges. However, the gap in averages is not quite as large between private and public universities. Public univeristy scores are still lower than private, but by far less than community college vs. private.
...
Based on these charts and other new data, we can see for certain thar there is a significant differences in SAT scores across college types. Similarly to what we saw early on, the biggest difference is between private universities and community colleges. 

2. Which specific college types differ from each other?

As we have talked about previously, the biggest gap in scores can be seen between private universities and community colleges. A gap between public and private universities does exist, but it is nowhere near as significant as the other gap.
...
Headline: Students at Private Universities Found to have Higher SAT Scores than Students at other types of Universities, according to new data. 

Recent data shows gaps in SAT Scores between different college types. The most notable difference is that of the differences between private universities and community colleges. There is a gap here of 366.96 points, meaning that private colleges have SAT scores that about 366.96 points higher than community colleges. Other differences and gaps can be seen between the other comparisons, but the gap between private and community is the largest and most significant.
